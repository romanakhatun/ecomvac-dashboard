...
const StateCard = ({ item }) => {
  return (
    <div className="card bg-white shadow-sm border border-slate-100 overflow-hidden group ">
      <div
      // className={`h-1.5 w-full ${item.bg.replace("bg-", "bg-").replace("/10", "")} brightness-95 opacity-80`}
      ></div>
      <div className="card-body p-4">
        ...
        <div className="flex items-center justify-between mt-5 pt-2 border-t border-[#f0f0f0]">
          <div
